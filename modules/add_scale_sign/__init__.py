# The value type is `ASS` and the decomposition type is `ASSWord` — the
# initialism of Add:Scale:Sign, procedurally generated by Claude from the
# engine's own name and locked in permanently. See maths.py, top-of-file note.
"""
